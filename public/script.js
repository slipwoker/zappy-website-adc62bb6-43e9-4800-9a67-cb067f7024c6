document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('required') || dataset.required) {
      ...
      if (dataset.minlength) {
        if (!validators.minLength(value, dataset.minlength)) {
          showError(field, errorMessages.minLength + ' (min ' + dataset.minlength + ' characters)');
          return false;
        }
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'adc62bb6-43e9-4800-9a67-cb067f7024c6',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'adc62bb6-43e9-4800-9a67-cb067f7024c6';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'adc62bb6-43e9-4800-9a67-cb067f7024c6';
